<?php
//Load Controller
Application::loadController("new-issue");
...
<div class="container shadow col-xl-10 col-xxl-8 px-4 py-5" style="margin: 100px auto;">
    ...
    <div class="card" style="margin-bottom: 30px;">
        <div class="card-body">
            ...
            <a href="?page=known-issues" target="_blank" class="btn btn-success">View known bugs</a>
        </div>
    </div>
    ...
    <form class="row g-3" method="POST" action="" onsubmit="return validate();">
        ...
        <script src="<?= SCRIPT_PATH ?>/new-issue.js"></script>
    </form>
</div>
